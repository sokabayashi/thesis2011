...
{E:ERGM} that belies the challenges involved in parameter estimation which
...
used for exponential families with complex dependence like ERGMs.  All approaches avoid evaluating the likelihood function directly.  
...
the maximum pseudolikelihood method to social network models, a method first used in lattice systems in plant biology \citep{Besag:1974}.  \citet{Strauss:1990} further justified the use of 
...
$\exp \left (  c(\eta) - c(\eta^0) \right )$, as follows:
\begin{align*}
