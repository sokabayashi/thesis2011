...
%\input{Introduction}
\section{Motivation: Social network modeling}
...
%This was the question that led to my eventual research in the area of parameter estimation for exponential families with complex dependence.  
Studies of social networks typically look to identify gender, age, ethnicity, and other individual-specific attributes to explain which relationships form.  However, it has long been known that potential relationships cannot be studied in isolation; rather, they form in an interdependent manner.  Whether or not a relationship forms between individuals $A$ and $B$ may very well depend on whether or not a relationship forms between $B$ and $C$.  This necessitates a new ``network" perspective that recognizes relationship structures themselves as factors in the analysis.  
