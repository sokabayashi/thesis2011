...
\end{table}
%
% FILE USED: on stat directory, Tako/THESIS/RCode/fauxmagnolia-lr-2nd.R
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Case: MLE does not exist; observed statistic in one-dimensional face}
...
To construct one-sided 95\% confidence intervals for how close $\eta$ is to
...
\begin{align*}
	\etaLCM = (28.6, -6.9 ).
\end{align*}
%theta current (updated) 28.63898 -6.921753 
...
%Thus in this case, $\hat{\eta}_{\widetilde{\textrm{LCM}}}$ and $\etaMLE$ index nearly identical distributions of the 
%empirical $\widetilde{\textrm{LCM}}$.
