...
trajectory of the sequence $\eta_k$ \citep[Chapter 3.1]{Sun:2006}  as 
...
directions of recession, which we discuss how to find in Section~\ref{S:GDOR calc},
...
such as Metropolis-Hastings \citep[Chapter 1]{Brooks}, which is typically used for ERGMs, or 
...
\end{align*}
and a function $h(\fatdot)$ where $\nabla h(\fatdot)$ is defined and non-zero,
\begin{align*}
