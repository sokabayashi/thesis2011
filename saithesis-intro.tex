...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=5in]{samplike}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=5in]{ecoli}
\end{center}
...
\begin{table}[h!] 
\caption{Sample space size for networks with different number of 
actors.}
...
not capture triangular tie configurations (or anything more copmlicated) in which dyads are dependent.  Also, to 
...
{\includegraphics[width=3.2in]{mcmc-mle1}}
{\includegraphics[width=3.2in]{mcmc-mle-1}}
\end{center} 
...
& 	converges 	&  \textbullet \, Requires second derivative matrix and its\\	
&				& inverse \\[1ex]
\hline
\multirow{3}{0.5in}{SA} 		
...
&				& \textbullet \, Requires calculation of second derivative \\
&				& matrix and its inverse \\[1ex]
\hline
...
& 	converge to MLE, though & \textbullet \, Convergence conditions not easily\\
& 	under restrictive conditions.  & implemented in practice.\\[1ex]
\hline 
\end{tabular} 
...
\begin{figure}[h!]
\centering
\includegraphics[width=5in]{Figures/g9-hull}
