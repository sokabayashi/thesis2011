...
\citep{ergm}.
This is not an issue with the parameter estimation method; instead, it is a result of a poorly specified model---ERGMs give tremendous
flexibility model specification but with no guarantees that a model will behave exactly as desired.  \citet*{GOF} devise graphical tests for evaluating the goodness of fit of ERGMs.
