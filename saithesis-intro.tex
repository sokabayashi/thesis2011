...
MCMC Newton \citep{Penttinen:1984}
...
estimation for ERGMs, which have come to very loosely be referred 
...
From the practitioner's perspective, degeneracy and near degeneracy
are confounded with models that are 
...
Due to the ambiguity over the usage of the term ``degeneracy'', we will
instead say that the MLE does not exist in the conventional sense.
