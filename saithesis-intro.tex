...
does \textbf{[MUST?]} exist and can be found using conventional methods such as logistic regression.  \textbf{[EXAMPLE? MORE DETAIL?]}
...
model specification rather than any pernicious theoretical oddity.
