...
converge, which typically occurs when the initial $\eta_k$ is far from the solution.  However,
...
It is still possible for a well-fit model to poorly describe or ``resemble" the 
