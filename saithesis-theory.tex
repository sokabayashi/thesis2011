...
$g(\yobs)$ in mean parameterization goes from zero to one in a strictly increasing manner.  This event of observing
corresponds exactly to the event $g(Y) \in H$, 
and thus we look to find the
