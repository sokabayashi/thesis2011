...
in the family.  The models with $g(\yobs)$ on the this relative boundary
are the degenerate models mentioned in Section~\ref{S:Non-existent MLE};
it is clear from this mean value parameterization perspective that the MLEs
for these do not exist in the conventional sense.
...
We may be interested in characterizing the
